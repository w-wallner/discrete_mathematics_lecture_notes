\begin{figure}[htb]
  ...
  \subfigure[$K_5$, nonplanar]{
    \begin{tikzpicture}
      \fullyConnectedGraph{90, 30, 180-30, -90-45, -90+45}{1.25cm}
    \end{tikzpicture}
  }
  \subfigure[$K_{3,3}$, nonplanar, bipartite]{
  ...
  \caption{Examples for (not-)planar Graphs}
\end{figure}
