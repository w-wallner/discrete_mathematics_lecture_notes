...
\textbf{Assumtions.}
Let $(\mathbb{P}, \leq)$ be a locally finite poset. And we have a map $f \rightarrow \mathbb{R}, some function $S_f(x) = \sum_{z \leq x} f(z)$
...
if $\forall x,y \in P: \sum_{z\in[xy]} \mu (z,y) = \delta_{x,y} = \choices{1 if x= y \\ 0 \quad otherwise}$
\end{definition}
