...
An element $x \in A$ is a \dt{maximal element} if $y \geq x \implies x=y$. 

An element $x \in A$ is the \dt{0-element} if $\forall y \in A : x \leq y$. 
Every 0-element is minimal. 

An element $x \in A$ is the \dt{1-element} if $\forall y \in A : x \geq y$.
